...
| Current journey map and original architecture proposal | [`architecture.md`](architecture.md)                                                     |
...
| Auckland DEM source, limits, and slope research        | [`auckland-2024-lidar-dem-slope-research.md`](auckland-2024-lidar-dem-slope-research.md) |

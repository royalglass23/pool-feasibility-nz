...
export function AucklandPropertyJourney() {
  return (
    <section
      className="relative isolate overflow-hidden rounded-2xl bg-[#dbe8f0] shadow-[0_8px_8px_-6px_rgba(24,50,47,0.2)]"
    ...
    >
      ...
      />
      <div className="relative z-10 flex min-h-[590px] max-w-xl flex-col justify-between px-6 py-8 sm:px-10 sm:py-12 lg:min-h-[620px] lg:px-12 lg:py-14">
        <div>
          ...
          <p className="mt-6 max-w-md text-base leading-7 text-pretty text-[#426b87] sm:text-lg sm:leading-8">
            Search an Auckland address, place a pool concept on the map, and see
            what deserves a closer look before you plan further.
          </p>
        </div>

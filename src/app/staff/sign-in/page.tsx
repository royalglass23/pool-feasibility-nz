...
export default async function StaffSignInPage({
  ...
  return (
    <main className="grid min-h-screen place-items-center bg-pool-950 px-4 py-10 sm:px-6">
      <section className="w-full max-w-md rounded-3xl bg-white p-6 shadow-2xl sm:p-8">
        ...
        <h1 className="mt-3 text-3xl font-semibold tracking-[-0.035em] text-pool-950">
        ...
        <form action={signInStaffAdmin} className="mt-7 space-y-5">
          <label className="block text-sm font-semibold text-pool-800">
            Username
            <input
              autoComplete="username"
              className="mt-2 block min-h-11 w-full rounded-xl border border-pool-300 bg-white px-3 text-base shadow-sm outline-offset-2 focus:border-pool-blue-700 focus:outline-2 focus:outline-pool-blue-700"
              name="username"
              required
            />
          </label>
          ...
          <button
            className="inline-flex min-h-11 w-full items-center justify-center rounded-xl bg-pool-blue-800 px-4 py-2 text-sm font-bold text-white shadow-sm transition hover:bg-pool-blue-900 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-pool-blue-700"
            type="submit"
          >
            Sign in
          </button>

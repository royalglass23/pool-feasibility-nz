...
import { reportConstructabilitySections } from "@/modules/reporting/preliminary-report-presentation";
import {
...
function emailForHomeowner(
  ...
  const selectedPool = formatNamedPoolLayout(claim.report.pool);
...
function supportFormAnswers(
  ...
  return [
    ...
    ["Selected pool", formatNamedPoolLayout(claim.report.pool)],
